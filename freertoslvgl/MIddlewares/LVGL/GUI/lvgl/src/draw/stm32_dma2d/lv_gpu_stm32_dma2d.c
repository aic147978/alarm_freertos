...
/* ---- Compatibility shims for older STM32F4 headers (no *_Pos / *_Msk) ---- */
/* NLR register: NL[15:0], PL[31:16] */
...
/* CR register: START bit mask */
#ifndef DMA2D_CR_START_Msk
/* older headers only define DMA2D_CR_START as a bit value; use it as mask */
#define DMA2D_CR_START_Msk        DMA2D_CR_START
#endif

/* FGPFCCR register: AM[17:16], ALPHA[31:24] */
