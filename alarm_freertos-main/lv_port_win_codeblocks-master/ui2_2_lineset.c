...
static void kb_left_ok(float v, void *ud){ LV_UNUSED(ud); if (v<0) v=0; if (v>s_max_limit) v=s_max_limit; s_left_cnt=(uint16_t)v; char t[8]; fmt_u16(t,sizeof t,s_left_cnt); btn_set_text(s_btn_left,t); apply_call(); }
static void kb_right_ok(float v, void *ud){ LV_UNUSED(ud); if (v<0) v=0; if (v>s_max_limit) v=s_max_limit; s_right_cnt=(uint16_t)v; char t[8]; fmt_u16(t,sizeof t,s_right_cnt); btn_set_text(s_btn_right,t); apply_call(); }
static void on_click_left_num(lv_event_t *e){ LV_UNUSED(e); if (!s_open_kb) return; s_open_kb(s_btn_left,  "left count",  (float)s_left_cnt,  0, kb_left_ok,  NULL); }
static void on_click_right_num(lv_event_t *e){ LV_UNUSED(e); if (!s_open_kb) return; s_open_kb(s_btn_right, "right count", (float)s_right_cnt, 0, kb_right_ok, NULL); }
...
void ui22_bind_number_keyboard(ui22_open_kb_fn fn){ s_open_kb = fn; }
